...
export class PatientService {
    ...
    async getPatient(id: string): Promise<PatientExitDto> {
        return this.patientRepository.findOne({where: {patientId: id}});
    }
    ...
    async getCivilStatus(civilStatusId: string): Promise<CivilStatus> {
        return this.civilStatusRepository.findOne({where: {civilStatusId: civilStatusId}});
    }
    ...
    async getCity(cityId: string): Promise<City> {
        return this.cityRepository.findOne({where: {cityId: cityId}});
    }
    ...
    async getGender(genderId: string): Promise<Gender> {
        return this.genderRepository.findOne({where: {genderId: genderId}});
    }
    ...
    async getPopulation(populationId: string): Promise<Population> {
        return this.populationRepository.findOne({where: {populationId: populationId}});
    }
    ...
    async getMunicipality(municipalityId: string): Promise<Municipality> {
        return this.municipalityRepository.findOne({where: {municipalityId: municipalityId}});
    }
